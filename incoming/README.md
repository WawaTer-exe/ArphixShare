...
You can also upload MP4 files directly into this folder. The workflow imports up to 20 MP4s per run into `videos/`, creates playable HTML pages from `videos/example.html`, and refreshes the Hot Videos section on the homepage.
